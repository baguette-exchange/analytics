...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://app.baguette.exchange/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://app.baguette.exchange/#/swap?inputCurrency=${token0Address === WAVAX_ADDRESS ? 'AVAX' : token0Address
