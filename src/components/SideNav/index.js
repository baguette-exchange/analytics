      ...
      {!below1080 ? (
        <DesktopWrapper>
          ...
          <AutoColumn gap="0.5rem" style={{ marginLeft: '.75rem', marginBottom: '4rem' }}>
            <HeaderText>
              <Link href="https://app.baguette.exchange" target="_blank">
                Baguette
              </Link>
            </HeaderText>
            <HeaderText>
            ...
            <HeaderText>
              <Link href="https://twitter.com/Baguette_avax" target="_blank">
                Twitter
              </Link>
            </HeaderText>
            <HeaderText>
              <Link href="https://markr.io/#/applications/Baguette" target="_blank">
                Markr.io
              </Link>
            </HeaderText>
            <HeaderText>
